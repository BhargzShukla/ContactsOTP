...
public class MessageListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView mMessageRecyclerView = rootView.findViewById(R.id.recyclerview_messages);
        final MessageListAdapter messageListAdapter = new MessageListAdapter(getActivity());
        mMessageRecyclerView.setAdapter(messageListAdapter);
        mMessageRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        mMessageViewModel = ViewModelProviders.of(this).get(MessageViewModel.class);
        mMessageViewModel.getAllMessages().observe(this, messageListAdapter::setMessages);
        return rootView;
    }
